...
print(f"\033[1m{cedulas_100} \033[3m Notas de R$ 100 \033[0m")
print(f"\033[1m{cedulas_50} \033[3m Notas de R$ 50 \033[0m")
print(f"\033[1m{cedulas_20} \033[3m Notas de R$ 20 \033[0m")
print(f"\033[1m{cedulas_10} \033[3m Notas de R$ 10 \033[0m")
print(f"\033[1m{cedulas_5} \033[3m Notas de R$ 5 \033[0m")
print(f"\033[1m{cedulas_2} \033[3m Notas de R$ 2 \033[0m")
print(f"\033[1m{moedas_1} \033[3m Moedas de R$ 1 \033[0m")
